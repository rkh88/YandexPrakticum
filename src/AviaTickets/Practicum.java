...
class Practicum {
    ...
    private static void printFlightInformation(
        ...
        try {
            ...
            LocalDateTime ldt = LocalDateTime.parse(formattedDepartureTime, DATE_TIME_FORMATTER);
            ZoneId zoneId = ZoneId.of(departureAirport.getZone());
            ZonedDateTime departure = ZonedDateTime.of(ldt, zoneId);
            ...
            String formattedArrivalTime = arrival.format(DateTimeFormatter.ofPattern(arrival.format(DATE_TIME_FORMATTER)));
            // Только время вылета
            String departureTimeOnly = departure.format(DateTimeFormatter.ofPattern(departure.format(DATE_TIME_FORMATTER)));
            ...
            System.out.println("Неизвестный код аэропорта ");
        }
